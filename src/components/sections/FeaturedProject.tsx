      ...
      <div className="trace-section relative">
        <div className="trace-container max-w-[82rem]">
          ...
          >
            ...
            <div className="trace-section-box grid gap-8 rounded-[calc(var(--radius-frame)-0.45rem)] p-5 sm:p-7 md:gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-14 lg:p-12 xl:p-14">
              <div className="space-y-5 md:space-y-6">
                ...
                <p className="max-w-lg text-sm leading-7 text-zinc-300/90 sm:text-base sm:leading-8">
                  A cinematic commerce presentation built around material
                  detail, measured motion, and a luxury-grade browsing rhythm
                  for a flagship product launch.
                </p>
                <a
                  href="#work"
              ...
              <div className="relative lg:pl-4">
                ...
                <div className="trace-panel-slot relative rounded-[var(--radius-card)]">
                  <Image
